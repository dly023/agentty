...
; Builds before the agentty/tty7-app split installed the GUI as agentty.exe. Upgrading
...
Source: "{#StageDir}\tty7-server.exe"; DestDir: "{app}"; Flags: ignoreversion
...
; Both helpers are required by bundle-windows.ps1; an incomplete payload must fail packaging.
Source: "{#StageDir}\server\*"; DestDir: "{app}\server"; Flags: ignoreversion recursesubdirs

[Icons]
Name: "{autoprograms}\agentty"; Filename: "{app}\tty7-app.exe"
Name: "{autodesktop}\agentty"; Filename: "{app}\tty7-app.exe"; Tasks: desktopicon

[Run]
Filename: "{app}\tty7-app.exe"; Description: "{cm:LaunchProgram,agentty}"; Flags: nowait postinstall skipifsilent
