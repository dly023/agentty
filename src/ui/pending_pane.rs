...
pub struct PendingSpawn {
    ...
    pub live_binding: agentty_core::core::session::LiveContainerBinding,
    pub resume_invocation: Option<agentty_core::agent_runtime::ResumeInvocation>,
    pub navigator_row_id: Option<agentty_core::agent_runtime::NavigatorRowId>,
