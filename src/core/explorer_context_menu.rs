...
mod tests {
    ...
    fn registration_targets_both_directory_surfaces() {
        ...
        assert_eq!(directory.location.label(), "Open in agentty");
        ...
        assert_eq!(background.location.label(), "Open agentty here");
    ...
    fn the_verb_labels_follow_the_ui_language() {
        ...
        assert_eq!(Location::Directory.label(), "在 agentty 中打开");
        assert_eq!(Location::Background.label(), "在此处打开 agentty");

        crate::ui::i18n::set_locale("ja-JP");
        assert_eq!(Location::Directory.label(), "agentty で開く");
        assert_eq!(Location::Background.label(), "ここで agentty を開く");

        crate::ui::i18n::set_locale("en");
        assert_eq!(Location::Directory.label(), "Open in agentty");
        assert_eq!(Location::Background.label(), "Open agentty here");
    }
