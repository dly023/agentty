...
The old **New Workspace** shortcut has been removed. Machines are shown together
in the sidebar; use the **+** environment menu to manage connections and **New
Tab** to create a session. Retired shortcuts are not reassigned to Disconnect
or Sleep. [Current actions →](/reference/keyboard-shortcuts)
