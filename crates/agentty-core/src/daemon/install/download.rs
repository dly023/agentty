...
impl Default for HttpsFetcher {
    fn default() -> Self {
        let config = ureq::Agent::config_builder()
            ...
            .user_agent(concat!("agentty/", env!("CARGO_PKG_VERSION")))
            .build();
        Self {
            agent: config.into(),
        }
...
mod tests {
    ...
    fn talks_to_github() {
        ...
        let bytes = fetcher
            .get("https://github.com/dly023/agentty/raw/main/README.md")
        ...
        let missing = super::super::asset::download_url("v0.0.0-never", "agentty-server-nope");
        let err = fetcher
            .get(&missing)
