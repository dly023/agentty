...
pub const SERVICE_PASSWORD: &str = "agentty-ssh";
pub const SERVICE_KEY_PASSPHRASE: &str = "agentty-ssh-key";
...
mod tests {
    ...
    fn credential_kind_selects_service() {
        assert_eq!(CredentialKind::Password.service(), "agentty-ssh");
        assert_eq!(CredentialKind::KeyPassphrase.service(), "agentty-ssh-key");
    }
