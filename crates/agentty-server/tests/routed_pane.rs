...
use agentty_core::daemon::protocol::{ClientMsg, DaemonMsg, ShellSpec, WinSize};
use agentty_core::daemon::router::{RemoteRouter, RouteChannel, RouteHeader, negotiate};
...
fn the_channel_decides_which_dialect_the_route_carries() {
    ...
    let (_, payload) = agentty_core::daemon::protocol::read_frame(&mut buf.as_slice()).unwrap();
