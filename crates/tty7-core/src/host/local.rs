...
impl Host for LocalHost {
    ...
    fn agent_sessions(&self) -> io::Result<crate::agent_sessions::HistorySnapshot> {
        guard_off_ui();
        crate::agent_sessions::scan_current_process()
    }
    ...
    fn watch_agent_session_titles(
        ...
        guard_off_ui();
        crate::agent_sessions::live_titles::watch_history_current(snapshot)
    }
    ...
    fn validate_agent_session(
        ...
        guard_off_ui();
        crate::agent_sessions::validate_current_process(session)
    }
    ...
    fn resolve_agent_session(
        ...
        guard_off_ui();
        crate::agent_sessions::resolve_current_process(identity)
    }
...
mod tests {
    ...
    #[test]
    fn history_title_local_host_rejects_oversized_interest() {
        ...
        let snapshot = HistorySnapshot {
            sessions: vec![
                HistorySession {
                    ...
                    id: "untrusted".into(),
                    title: "not a provider fact".into(),
                    cwd: String::new(),
        ...
        let error = LocalHost::new()
            .watch_agent_session_titles(&snapshot)
            .err()
            .unwrap();
        assert_eq!(error.kind(), io::ErrorKind::InvalidInput);
        assert_eq!(error.to_string(), "too many title interests");
