...
use agentty_core::daemon::control::{ControlEvent, ControlHelloOk, ControlRequest, ReplyOk};
use agentty_core::daemon::protocol::{PaneInfo, PaneProcs, WinSize};
use anyhow::Result;
...
pub mod mock {
    ...
    use agentty_core::core::machine::Machine;
    use agentty_core::core::session::WorkspaceId;
    use agentty_core::daemon::control::{
        CONTROL_VERSION, ControlEvent, ControlHelloOk, ControlRequest, ReplyOk, feature,
    };
    use agentty_core::daemon::protocol::{PROTOCOL_VERSION, PaneInfo, PaneProcs};
    use anyhow::Result;
